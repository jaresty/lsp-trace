...
require CI-PYTHON 'python3 -m py_compile scripts/retain-qualification.py scripts/check-program-c-profiles.py scripts/test-program-c-profiles.py scripts/check-program-c-gate-ii.py scripts/test-program-c-gate-ii.py scripts/check-program-c-gate-ii-v4.py scripts/test-program-c-gate-ii-v4.py'
