...
assert_contains R-SKILL-EXPORT-SAFETY cmd/lsp-trace/SKILL.md 'atomic no-replace final rename descriptor-relatively beneath it'
assert_contains R-SKILL-EXPORT-NO-DURABILITY cmd/lsp-trace/SKILL.md 'does not promise crash durability'
