...
func newRegistryWithRoutingAndProfile(publicationSupported bool, routing Routing, profile ToolProfile) *Registry {
	...
	descriptions := map[string]string{
		...
		"lsp_trace_v2_slice":                     "DEPRECATED producer: migrate new production to source-qualified Graph Provenance V5. Acquire ordered required targets with shared limits and retained directed witnesses; historical dispatch remains compatible",
		"lsp_trace_v2_incoming":                  "DEPRECATED producer: migrate new production to source-qualified Graph Provenance V5. Acquire ordered required callers with shared limits and required-to-root witnesses; historical dispatch remains compatible",
		"lsp_trace_v3_slice":                     "DEPRECATED producer: migrate new production to source-qualified Graph Provenance V5. Acquire graph-provenance/v3 with exact embedded V2 bytes and bounded managed diagnostics for one exact session generation; historical dispatch remains compatible",
		"lsp_trace_v3_incoming":                  "DEPRECATED producer: migrate new production to source-qualified Graph Provenance V5. Acquire incoming graph-provenance/v3 with exact embedded V2 bytes and bounded managed diagnostics for one exact session generation; historical dispatch remains compatible",
