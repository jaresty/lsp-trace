...
const (
	...
	ContextSymbolChurnSuccessV4ID   = "https://jaresty.github.io/lsp-trace/mcp/schemas/envelope-context-symbol-churn-result.v4.schema.json"
...
func WithContextSymbolChurn(m *Manifest) *Manifest {
	...
	c.Schemas = append(c.Schemas,
		...
		SchemaRegistration{ID: ContextSymbolChurnSuccessV4ID, Family: "envelope-context-symbol-churn-result.v4", Layer: "envelope", Path: "schemas/envelope-context-symbol-churn-result.v4.schema.json"},
...
func ValidateContextSymbolChurnEnvelopeExclusive(raw []byte) error {
	...
	if id != ContextSymbolChurnSuccessID && id != ContextSymbolChurnSuccessV2ID && id != ContextSymbolChurnSuccessV3ID && id != ContextSymbolChurnSuccessV4ID && id != ContextSymbolChurnDomainErrorID {
