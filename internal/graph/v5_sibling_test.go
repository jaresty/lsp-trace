...
func TestV5SiblingEvidenceRoundTripAndFieldMutations(t *testing.T) {
	...
	mutations := []struct {
		...
		{"custody", func(c *SiblingCandidate) { c.Custody = "OTHER" }},
	}
