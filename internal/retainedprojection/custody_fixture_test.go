...
func validCustodyArtifact(t *testing.T) []byte {
	t.Helper()
	root := t.TempDir()
	...
	seedDigest := custodyDigest(content)
...
func custodyDigest(raw []byte) string {
