...
assert_contains DOC-MCP-FULL-COMPAT README.md 'compatibility `--tool-profile full` publishes exactly 43 canonical tools'
...
assert_contains DOC-PI-COMPACT-THIRTEEN README.md 'The recommended compact tool-advertisement profile advertises exactly thirteen canonical MCP names'
