	...
	t.Run("ASSERT_PACKAGE_OWNERSHIP_ONLY", func(t *testing.T) {
		...
		for _, line := range strings.Split(strings.TrimSpace(string(out)), "\n") {
			...
			owned := ownsFR20FR21Path(path) || path == "sessionruntime/sessionruntime.go" || path == "sessionruntime/sessionruntime_test.go" || path == "sessionruntime/roundtrip_test.go" || path == "sessionruntime/local_darwin_integration_test.go" ||
				...
				path == "internal/lsp/types.go" || path == "internal/graph/reconcile.go" || path == "internal/graph/reconcile_test.go" || path == "internal/graph/relations.go" || path == "internal/graph/relations_test.go" || path == "internal/graph/result.go" || path == "internal/graph/v3.go" || path == "internal/graph/v5_multiple_sibling_test.go" || path == "internal/graph/snapshot_identity.go" || path == "internal/graph/snapshot_identity_test.go" || path == "internal/graph/schemas/normalized-relations.v1.schema.json" ||
				...
				path == "cmd/lsp-trace/retained_calls.go" || path == "cmd/lsp-trace/inspect_command.go" || path == "cmd/lsp-trace/inspect_hydrated.go" || path == "docs/retained-calls.md" || path == "docs/hydrated-evidence.md" ||
				strings.HasPrefix(path, "internal/retainedrelations/") || strings.HasPrefix(path, "internal/v5sourcesnapshot/") || strings.HasPrefix(path, "internal/hydratedevidence/") || strings.HasPrefix(path, "internal/hydratedinspection/") ||
				...
				strings.HasPrefix(path, "internal/programc/") || path == "scripts/check-program-c-profiles.py" || path == "scripts/test-program-c-profiles.py" || path == "scripts/qualify-program-c-ember-callback-flow.py" || path == "scripts/test-program-c-ember-callback-flow.py" || path == "scripts/qualify-program-c-ember-state-flow.py" || path == "scripts/test-program-c-ember-state-flow.py" || path == "scripts/qualify-program-c-ui-lifecycle.mjs" || path == "scripts/test-program-c-ui-lifecycle.mjs" || path == "qualification/program-c/profile-qualification-receipt.v1.schema.json" || path == "qualification/program-c/profile-qualification.tsv" || path == "qualification/program-c/callback-flow-v1-typescript-ember-ember-glint-1.0.3.receipt.json" || path == "qualification/program-c/state-flow-v1-typescript-ember-ember-glint-1.0.3.receipt.json" || path == "qualification/program-c/ui-lifecycle-v1-typescript-ember-ember-glint-1.0.3.receipt.json" || path == "qualification/program-c/gate-i-receipts.tsv" || path == "qualification/program-c/gate-i-i-01-all-profiles.receipt.txt" || path == "schema/schemas/lsp-trace.program-c-profile-qualification-receipt.v1.schema.json" || path == "internal/schema/schemas/lsp-trace.program-c-profile-qualification-receipt.v1.schema.json"
			if !owned {
