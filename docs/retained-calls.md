...
The current runtime has exactly 23 canonical tools, sorted as: `lsp_session_v1_list`,
...
`lsp_trace_v2_slice`, `lsp_trace_v2_verify`, and `lsp_trace_v2_verify_retained_calls`.
