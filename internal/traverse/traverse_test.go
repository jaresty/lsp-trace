...
func TestIncomingSchemaV1CompatibilityProjection(t *testing.T) {
	...
	if !bytes.Contains(encoded, []byte(`"complete":true`)) || !bytes.Contains(encoded, []byte(`"reason":"NO_INCOMING_CALLS"`)) || bytes.Contains(encoded, []byte(`capability_quality`)) || bytes.Contains(encoded, []byte(`"tool"`)) || bytes.Contains(encoded, []byte(`"provenance"`)) {
...
func TestIncomingCanonicalV2GoldenByteIdentical(t *testing.T) {
	...
	const want = `{"schema_version":"lsp-trace.graph.v2","tool":{"name":"lsp-trace","version":"UNKNOWN"},"invocation":{"workspace_uri":"","target":{"uri":"","line":0,"column":0},"server":{"command":"","arguments":null},"limits":{"max_depth":0,"max_nodes":0,"timeout_ms":0},"provenance":{"invocation_id":"UNKNOWN","caller":"UNKNOWN","source":"UNKNOWN","source_revision":"UNKNOWN","server_version":"UNKNOWN","timestamp":"UNKNOWN"}},"evidence_semantics":{"call_edges":{"evidence_class":"SERVER_REPORTED_CALL_HIERARCHY","supports":["server_reported_caller_callee_relation"],"does_not_support":["runtime_execution","feature_identity","whole_source_completeness","independent_source_confirmation"],"support_contribution":1},"discovery_relations":{"evidence_class":"DISCOVERY_NOMINATION","supports":["candidate_for_separate_investigation"],"does_not_support":["caller_callee_relation","runtime_execution","feature_identity","whole_source_completeness"],"support_contribution":0}},"trace_receipt":{"receipt_version":"lsp-trace.receipt.v1","content_digest":"sha256:72785e7f43255bf10e980521982e079663924ea5a7dded962d933cdbc8d55e8a","digest_scope":"CANONICAL_GRAPH_WITHOUT_TRACE_RECEIPT"},"capabilities":{"call_hierarchy_provider":false},"capability_quality":{"advertised":false,"prepare_succeeded":true,"incoming_request_successes":1,"incoming_edges":0,"cross_file_edges":0,"cross_module_edges":"UNKNOWN","unresolved_calls":0,"dynamic_calls":0},"targets":["f170a06be92aae4db099707bbfd2b3773f84f9f159e5e49d1cb0a9f1bce158af"],"nodes":[{"id":"f170a06be92aae4db099707bbfd2b3773f84f9f159e5e49d1cb0a9f1bce158af","name":"leaf","kind":12,"uri":"file:///w/a.go","range":{"start":{"line":8,"character":0},"end":{"line":8,"character":4}},"selection_range":{"start":{"line":8,"character":0},"end":{"line":8,"character":4}},"data":{"name":"leaf"}}],"edges":null,"terminals":[{"node_id":"f170a06be92aae4db099707bbfd2b3773f84f9f159e5e49d1cb0a9f1bce158af","reason":"SERVER_REPORTED_NO_INCOMING_CALLS","provenance":"SERVER_REPORTED"}],"frontier":null,"diagnostics":null,"summary":{"node_count":1,"edge_count":0,"terminal_count":1,"cycle_count":0,"traversal_complete":true,"source_graph_complete":"UNKNOWN","completeness_scope":"SERVER_REPORTED_CALL_HIERARCHY","truncated":false}}`
