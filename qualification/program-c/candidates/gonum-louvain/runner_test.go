...
func TestQualificationContractUnchanged(t *testing.T) {
	...
	if e != nil || Runs != 3 || Permutations != 1 || MaxNodes != 10_000 || MaxEdges != 100_000 || CandidateVersion != "v0.17.0" || len(fixtures) != 4 || len(inventory.Seeds) != 2 || inventory.Seeds[0] != 1 || inventory.Seeds[1] != 2 {
