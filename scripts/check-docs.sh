...
assert_contains DOC-MCP-FULL-COMPAT README.md 'compatibility `--tool-profile full` publishes exactly 42 canonical tools'
...
assert_contains DOC-PI-COMPACT-TWELVE README.md 'The recommended compact tool-advertisement profile advertises exactly twelve canonical MCP names'
