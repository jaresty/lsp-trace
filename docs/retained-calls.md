...
The current runtime has exactly 38 canonical tools, sorted as: `lsp_session_v1_list`,
...
`lsp_trace_v1_context_churn`, `lsp_trace_v1_custody_execute`, `lsp_trace_v1_execute`, `lsp_trace_v1_export_retained_calls`, `lsp_trace_v1_filter`,
