...
|---|---|---|---|
| I-01 | Substrate qualification | The trustworthy-substrate program is qualified under its canonical policy and matrix; blocked cells remain visible. | Keep Program C deferred. |
| I-02 | Deterministic-analysis qualification | Program B's required projection, components, metrics, PageRank/PPR, replay, resources, and CLI/MCP parity obligations are qualified. | Keep Program C deferred. |
