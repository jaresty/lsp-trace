...
test('ASSERT_ANALYZER_ADVERTISES_ONLY_INDEPENDENT_RELATIONS', () => {
  assert.deepEqual(SUPPORTED_RELATIONS, ['BINDS_ARGUMENT', 'RENDERS_FROM', 'SCRIPT_SYMBOL_DEFINITION', 'TYPED_TEMPLATE_DEFINITION'], 'ASSERT_ANALYZER_ADVERTISES_ONLY_INDEPENDENT_RELATIONS');
});
