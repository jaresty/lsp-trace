...
import (
	...
	_ "lsp-trace/internal/retainedreplay"
...
func TestDisabledIntegratedConformance(t *testing.T) {
	...
	t.Run("ASSERT_PACKAGE_OWNERSHIP_ONLY", func(t *testing.T) {
		...
		for _, line := range strings.Split(strings.TrimSpace(string(out)), "\n") {
			...
			owned := ownsFR20FR21Path(path) || path == "sessionruntime/sessionruntime.go" || path == "sessionruntime/sessionruntime_test.go" || path == "sessionruntime/transient_identity_test.go" || path == "sessionruntime/document_supply_behavior_test.go" || path == "sessionruntime/roundtrip_test.go" || path == "sessionruntime/local_darwin_integration_test.go" ||
				path == "internal/session/manager.go" || path == "internal/session/manager_test.go" || strings.HasPrefix(path, "internal/runtimeprofile/") || path == "sessionruntime/derive_workspace_test.go" ||
				...
				path == "README.md" || path == "GRAPH-V5-MANAGED-REPAIR.md" || path == "docs/PROVIDERS.md" || path == "docs/RELEASING.md" || path == "docs/cli-migration-diagnostics.md" || path == "scripts/check-docs.sh" || path == "docs/adr/0003-always-local-stage2.md" || path == "docs/adr/0003-persistent-mcp-language-server-sessions.md" || path == "docs/adr/0006-transient-live-structural-analysis.md" || path == "docs/adr/0007-optional-local-semantic-feature-index.md" || path == "docs/adr/0008-dehydrated-structural-evidence-and-deterministic-source-projection.md" || path == "docs/qualification/adr0007-adr0008-source-projection-plan.md" || path == "docs/qualification/adr0008-cross-mode-fixture-plan.md" || path == "qualification/adr0008-source-projection-matrix.v1.json" || strings.HasPrefix(path, "internal/sourceprojection/") || strings.HasPrefix(path, "internal/sourceprojectionv2/") || strings.HasPrefix(path, "internal/sourceprojectionv3/") || strings.HasPrefix(path, "internal/sourceposition/") || strings.HasPrefix(path, "internal/regexlocator/") || strings.HasPrefix(path, "docs/pilot/adr0007/") ||
				path == "cmd/lsp-trace/main.go" || path == "cmd/lsp-trace/main_test.go" || strings.HasPrefix(path, "cmd/lsp-trace/context_command") || strings.HasPrefix(path, "cmd/lsp-trace/context_delta_command") || strings.HasPrefix(path, "cmd/lsp-trace/context_churn") || path == "cmd/lsp-trace/cli_diagnostic.go" || path == "cmd/lsp-trace/cli_diagnostic_test.go" || path == "cmd/lsp-trace/census_command.go" || path == "cmd/lsp-trace/census_command_test.go" || path == "cmd/lsp-trace/census_runner.go" || path == "cmd/lsp-trace/census_runner_test.go" || path == "cmd/lsp-trace/census_assembly.go" || path == "cmd/lsp-trace/census_assembly_test.go" || path == "cmd/lsp-trace/census_core.go" || path == "cmd/lsp-trace/census_core_test.go" || path == "cmd/lsp-trace/census_discovery_adapter.go" || path == "cmd/lsp-trace/census_discovery_adapter_test.go" || path == "cmd/lsp-trace/discovery_filter.go" || strings.HasPrefix(path, "internal/census/") || strings.HasPrefix(path, "internal/censusacquisition/") || strings.HasPrefix(path, "internal/discoveryfilter/") || path == "cmd/lsp-trace/fake_server_test.go" || path == "cmd/lsp-trace/graph_provenance_test.go" || path == "cmd/lsp-trace/trace_command.go" || path == "cmd/lsp-trace/trace_command_test.go" || path == "cmd/lsp-trace/trace_process_test.go" || path == "cmd/lsp-trace/slice_command.go" || path == "fr1-typescript-call-hierarchy.claim.md" || path == "fr1.1-managed-language-id.claim.md" || strings.HasPrefix(path, "qualification/retained/fr1.1-managed-language-id/") || path == "cmd/lsp-trace/execution_command.go" || path == "cmd/lsp-trace/execution_command_test.go" || path == "cmd/lsp-trace/render_command.go" || path == "cmd/lsp-trace/render_command_test.go" || path == "cmd/lsp-trace/custody_command.go" || path == "cmd/lsp-trace/custody_command_test.go" || strings.HasPrefix(path, "internal/presentation/") ||
				path == "cmd/lsp-trace/SKILL.md" || path == "cmd/lsp-trace/references/transport-routing.md" || path == "cmd/lsp-trace-mcp/census_candidate_qualification_test.go" || strings.HasPrefix(path, "cmd/lsp-trace-mcp/context_symbol_churn_") || path == "cmd/lsp-trace-mcp/census_executor.go" || path == "cmd/lsp-trace-mcp/census_executor_test.go" || path == "cmd/lsp-trace-mcp/census_runtime.go" || path == "cmd/lsp-trace-mcp/census_runtime_test.go" || path == "cmd/lsp-trace-mcp/census_publication.go" || path == "cmd/lsp-trace-mcp/census_publication_test.go" || path == "cmd/lsp-trace-mcp/census_completion.go" || path == "cmd/lsp-trace-mcp/census_completion_test.go" || path == "cmd/lsp-trace-mcp/census_mcp_binding.go" || path == "cmd/lsp-trace-mcp/census_mcp_binding_test.go" || strings.HasPrefix(path, "internal/censusresult/") || path == "internal/graphkernel/analytics.go" || path == "internal/graphkernel/analytics_test.go" || path == "cmd/lsp-trace-mcp/main.go" || path == "cmd/lsp-trace-mcp/main_test.go" || path == "cmd/lsp-trace-mcp/runtime_trace.go" || path == "cmd/lsp-trace-mcp/bootstrap.example.v1.json" || path == "cmd/lsp-trace-mcp/bootstrap_discovery_test.go" || path == "cmd/lsp-trace-mcp/provider_collector.go" || path == "cmd/lsp-trace-mcp/provider_lifecycle_composition.go" || path == "cmd/lsp-trace-mcp/provider_lifecycle_composition_test.go" || path == "cmd/lsp-trace-mcp/process_integration_test.go" || path == "cmd/lsp-trace-mcp/public_analytics_v2_schema_process_test.go" || path == "cmd/lsp-trace-mcp/slice_selector_contract_process_test.go" || path == "cmd/lsp-trace-mcp/real_process_conformance_test.go" || path == "cmd/lsp-trace-mcp/testdata/fake-relation-provider/main.go" || path == "cmd/lsp-trace-mcp/bootstrap.go" || path == "cmd/lsp-trace-mcp/bootstrap_test.go" || path == "cmd/lsp-trace-mcp/bootstrap_process_test.go" || path == "cmd/lsp-trace-mcp/bootstrap_provider.go" || path == "cmd/lsp-trace-mcp/bootstrap_provider_test.go" || path == "bootstrap-provider-declarations.claim.md" ||
				strings.HasPrefix(path, "internal/liveprojection/") || strings.HasPrefix(path, "internal/utf16position/") || strings.HasPrefix(path, "internal/mcp/adr0008_") || path == "internal/mcp/registry.go" || path == "internal/mcp/registry_test.go" || strings.HasPrefix(path, "internal/mcp/advertised_schema") || path == "internal/mcp/operation42_red_test.go" || path == "internal/mcp/census_operation34_test.go" || path == "internal/mcp/trace_operation33_test.go" || strings.HasPrefix(path, "internal/mcp/structural_context") || strings.HasPrefix(path, "internal/mcp/structural_delta_") || strings.HasPrefix(path, "internal/mcp/context_churn_") || strings.HasPrefix(path, "internal/mcp/context_symbol_churn_") || strings.HasPrefix(path, "cmd/lsp-trace-mcp/structural_context_executor") || path == "internal/mcp/compact_profile_test.go" || path == "internal/mcp/feedback_stage1_test.go" || path == "internal/mcp/fr23_public_v3_red_test.go" || path == "internal/mcp/public_analytics_v2_test.go" || path == "internal/mcp/retained_calls_v2_test.go" || path == "internal/mcp/bootstrap_discovery_test.go" || path == "internal/mcp/normalized_provider_contract_test.go" || path == "internal/mcp/transport.go" || path == "internal/mcp/transport_test.go" || path == "internal/mcp/slice_selector_contract_test.go" || path == "internal/mcp/execution_transport_test.go" || path == "internal/mcp/execute_gateway_test.go" ||
				path == "internal/operation/types.go" || path == "internal/operation/custody_test.go" || path == "internal/operation/verify.go" || path == "internal/operation/verify_test.go" || path == "internal/operation/normalized_provider_schema_test.go" || path == "mcp-transport.claim.md" ||
				path == "internal/schema/denominator.go" || path == "internal/schema/denominator_test.go" || path == "internal/schema/family_test.go" || path == "internal/schema/schema.go" || path == "internal/schema/validation_core.go" || path == "internal/schema/compiled_cache.go" || path == "internal/schema/schemas/lsp-trace.source-denominator.v1.schema.json" || path == "internal/schema/schemas/lsp-trace.inspect-ancillary.v1.schema.json" || path == "internal/schema/schemas/lsp-trace.graph.v4.schema.json" || path == "schema/schemas/lsp-trace.execution.v1.schema.json" ||
				path == "internal/lsp/types.go" || path == "internal/graph/reconcile.go" || path == "internal/graph/reconcile_test.go" || path == "internal/graph/relations.go" || path == "internal/graph/relations_test.go" || path == "internal/graph/result.go" || path == "internal/graph/v3.go" || path == "internal/graph/preflight_native_v3.go" || path == "internal/graph/evidence_bundle_test.go" || path == "internal/graph/v5_multiple_sibling_test.go" || path == "internal/graphprovenance/v2.go" || path == "internal/graph/snapshot_identity.go" || path == "internal/graph/snapshot_identity_test.go" || path == "internal/graph/schemas/normalized-relations.v1.schema.json" ||
				path == "internal/source/receipt.go" || path == "internal/source/receipt_test.go" || path == "internal/source/discovery.go" || path == "internal/source/discovery_test.go" || path == "internal/source/discovery_receipt_bridge.go" || path == "internal/source/discovery_receipt_bridge_test.go" || path == "internal/source/snapshot_trust_bridge.go" || path == "internal/source/snapshot_trust_bridge_test.go" ||
				path == "internal/execution/manifest_decision_bridge.go" || path == "internal/execution/manifest_decision_bridge_test.go" || strings.HasPrefix(path, "internal/publication/") ||
				path == "internal/provider/runtime.go" || path == "internal/provider/collector.go" || path == "internal/provider/collector_test.go" || path == "internal/provider/semantic_binding.go" || path == "internal/provider/semantic_binding_test.go" || path == "internal/provider/revision_verifier.go" || path == "internal/provider/revision_bound_custody_test.go" || path == "internal/provider/provisioning.go" || path == "internal/provider/admission.go" || path == "internal/provider/admission_test.go" || path == "internal/provider/inventory.go" || path == "internal/provider/inventory_test.go" || path == "internal/mcp/provider_inventory_test.go" || path == "configured-provider-inventory.claim.md" || path == "generic-provider-conformance.claim.md" || strings.HasPrefix(path, "internal/providerconformance/") || path == "cmd/lsp-trace/provider_conformance_command.go" || path == "cmd/lsp-trace/provider_conformance_command_test.go" || path == "schema/schemas/lsp-trace.provider-conformance-request.v1.schema.json" || path == "schema/schemas/lsp-trace.provider-conformance-report.v1.schema.json" || path == "schema/schemas/lsp-trace.provider-collector-request.v1.schema.json" || path == "schema/schemas/lsp-trace.provider-observations.v1.schema.json" || strings.HasPrefix(path, "internal/mcpcontract/") || strings.HasPrefix(path, "incomingops/") || strings.HasPrefix(path, "sliceops/") || strings.HasPrefix(path, "internal/slicer/") || strings.HasPrefix(path, "internal/traverse/") || path == "dangling-seed-membership-normalization.claim.md" || strings.HasPrefix(path, "internal/execution/") || strings.HasPrefix(path, "internal/observationadapter/") || path == "observation-adaptation.claim.md" || path == "frozen-glint-qualification.claim.md" || strings.HasPrefix(path, "qualification/provider-qualification/") || strings.HasPrefix(path, "qualification/retained/provider-qualification/") || strings.HasPrefix(path, "qualification/retained/b05/") || strings.HasPrefix(path, "internal/integratedconformance/") || strings.HasPrefix(path, "internal/transientstructural/") || strings.HasPrefix(path, "internal/transientstructuraldelta/") || strings.HasPrefix(path, "internal/transientstructuralresult/") ||
				path == ".goreleaser.yaml" || path == "go.mod" || path == "go.sum" || path == "THIRD_PARTY_NOTICES" || strings.HasPrefix(path, "internal/schema/") || path == "scripts/assert-core-archive-boundary.sh" || path == "scripts/prepare-representative-qualification.py" || path == "scripts/test-representative-qualification-preflight.py" || path == ".github/workflows/ci.yml" || path == "external-package-boundary.claim.md" || strings.HasPrefix(path, "providers/ember-glint/") || strings.HasPrefix(path, "providers/source-constrained-synthetic/") || strings.HasPrefix(path, "qualification/source-constrained-synthetic/") || strings.HasPrefix(path, "qualification/retained/source-constrained-synthetic/") || strings.HasPrefix(path, "qualification/retained/target-b05-synthetic/") ||
				path == "cmd/lsp-trace-mcp/b05_frame6_qualification_test.go" || path == "scripts/qualify-external-provider.sh" || path == "scripts/qualify-b05-frame6.sh" || path == "scripts/build-b05-frame6-matrix.py" || path == "scripts/build-b05-qualification-evidence-v3.py" || path == "scripts/test-b05-qualification.sh" || path == "schema/schemas/lsp-trace.immutable-evidence-manifest.v1.schema.json" || path == "schema/schemas/lsp-trace.b05-qualification-evidence.v3.schema.json" || path == "schema/schemas/lsp-trace.b05-release-selection.v1.schema.json" || path == "internal/schema/schemas/lsp-trace.immutable-evidence-manifest.v1.schema.json" || path == "internal/schema/schemas/lsp-trace.b05-qualification-evidence.v3.schema.json" || path == "internal/schema/schemas/lsp-trace.b05-release-selection.v1.schema.json" || path == "scripts/release-check.sh" || path == "scripts/check-ci.sh" || path == "scripts/check-installed-pi-mcp-adapter-canary.sh" || path == "scripts/installed-pi-direct-tools-slice-selector-canary.ts" || path == "qualification/B05.md" || strings.HasPrefix(path, "internal/b05qualification/") || strings.HasPrefix(path, "qualification/external-provider/") || strings.HasPrefix(path, "qualification/retained/external-provider/") || path == "internal/provider/external_provider_production_test.go" || path == "internal/qualificationpolicy/production_release_policy_test.go" ||
				path == "caller-mcp-ledger.md" || path == "caller-omitted-module-resolution.claim.md" || path == "docs/PROVIDERS.md" || path == "docs/RELEASING.md" || path == "scripts/qualify-caller-project-javascript.sh" || path == "scripts/test-caller-project-javascript-qualification.sh" || strings.HasPrefix(path, "qualification/caller-project-javascript/") || strings.HasPrefix(path, "qualification/retained/caller-project-javascript/") ||
				path == "internal/retainedcalls/preflight_v2.go" || path == "internal/retainedcalls/v2_admission_test.go" || path == "internal/retainedcalls/v2_contract_test.go" || path == "internal/retainedcalls/v2_test.go" ||
				path == "cmd/lsp-trace/retained_calls.go" || path == "cmd/lsp-trace/inspect_command.go" || path == "cmd/lsp-trace/inspect_command_test.go" || path == "cmd/lsp-trace/inspect_capture_set.go" || path == "cmd/lsp-trace/inspect_hydrated.go" || path == "cmd/lsp-trace/inspect_hydrated_test.go" || path == "cmd/lsp-trace-mcp/hydrated_public_test.go" || strings.HasPrefix(path, "internal/operation/inspect_hydrated") || path == "docs/retained-calls.md" || path == "docs/hydrated-evidence.md" ||
				strings.HasPrefix(path, "internal/retainedrelations/") || strings.HasPrefix(path, "internal/vcssymbolsidecar/") || strings.HasPrefix(path, "internal/v5sourcesnapshot/") || strings.HasPrefix(path, "internal/v5sourcesnapshotv2/") || strings.HasPrefix(path, "internal/hydratedevidence/") || strings.HasPrefix(path, "internal/hydratedinspection/") || strings.HasPrefix(path, "internal/retainedinspection/") || strings.HasPrefix(path, "internal/retainedoperation/") || strings.HasPrefix(path, "internal/retainedreplay/") || strings.HasPrefix(path, "internal/retainedmanifest/") || strings.HasPrefix(path, "internal/retainedlifecycle/") || strings.HasPrefix(path, "internal/retainedresolver/") || strings.HasPrefix(path, "internal/passageverification/") || path == "qualification/retained-passage-verification-core-4b98a4e.md" || path == "cmd/lsp-trace/verify_passage.go" || path == "cmd/lsp-trace/verify_passage_test.go" || path == "cmd/lsp-trace/schema_commands.go" || path == "schema/schemas/lsp-trace.passage-verification.v1.schema.json" || path == "docs/SEMANTICS.md" || path == "docs/mcp-advertisement-profiles.md" || path == "docs/adr/0007-append-only-transient-structural-delta.md" ||
				path == "internal/seedformat/QUALIFICATION.md" || path == "internal/seedformat/schema.go" || path == "internal/seedformat/schema.json" || path == "internal/seedformat/seedformat.go" || path == "internal/seedformat/seedformat_test.go" || path == "cmd/lsp-trace/production_discovery.go" ||
				path == "internal/mcp/adr0004_profile_contract_test.go" || path == "internal/mcp/retained_calls_test.go" || path == "internal/operation/retained_calls.go" || path == "internal/operation/schema_handlers.go" || path == "internal/operation/retained_calls_version_test.go" || path == "internal/schema/schemas/lsp-trace.retained-relations.v1.schema.json" || path == "internal/schema/schemas/lsp-trace.graph-v5-source-snapshot.v1.schema.json" || path == "schema/schemas/lsp-trace.graph-v5-source-snapshot.v1.schema.json" ||
				strings.HasPrefix(path, "traceops/") || strings.HasPrefix(path, "structuralcontextsymbolops/") || path == "cmd/lsp-trace/references/live-tracing.md" || path == "cmd/lsp-trace-mcp/trace_executor.go" || path == "cmd/lsp-trace-mcp/trace_executor_test.go" || path == "cmd/lsp-trace-mcp/trace_transport_parity_test.go" || path == "cmd/lsp-trace-mcp/trace_negative_transport_parity_test.go" || path == "cmd/lsp-trace-mcp/trace_transport_parity_matrix_test.go" || strings.HasPrefix(path, "internal/captureset/") || strings.HasPrefix(path, "internal/capturesetinspection/") || path == "docs/adr/0005-internal-capture-set-publication-custody.md" || strings.HasPrefix(path, "internal/programc/") || strings.HasPrefix(path, "internal/programcadmission/") || strings.HasPrefix(path, "internal/programcpresentation/") || strings.HasPrefix(path, "internal/programctestfixture/") || path == "internal/mcp/program_c_instability_test.go" || path == "internal/mcpcontract/program_c_instability.go" || path == "internal/operation/program_c_instability.go" || path == "cmd/lsp-trace/program_c_instability.go" || path == "cmd/lsp-trace/program_c_instability_test.go" || strings.HasPrefix(path, "internal/communityregister/") || path == "cmd/lsp-trace/aggregate_communities.go" || path == "cmd/lsp-trace/community_register_test.go" || path == "docs/technical-community-register.md" || path == "schema/schemas/lsp-trace.technical-community-register.v1.schema.json" || path == "internal/mcp/program_c_leiden_test.go" || path == "internal/mcpcontract/program_c_leiden.go" || path == "internal/operation/program_c_leiden.go" || path == "cmd/lsp-trace/program_c_leiden.go" || path == "cmd/lsp-trace/program_c_leiden_test.go" || strings.HasPrefix(path, "internal/programccompose/") || path == "internal/mcp/program_c_compose_test.go" || path == "internal/mcpcontract/program_c_compose.go" || path == "internal/operation/program_c_compose.go" || path == "cmd/lsp-trace/program_c_compose.go" || path == "cmd/lsp-trace/program_c_compose_test.go" || path == "schema/schemas/lsp-trace.community-presentation.v1.schema.json" || path == "scripts/check-program-c-profiles.py" || path == "scripts/test-program-c-profiles.py" || path == "scripts/check-composite-leiden-admission.sh" || path == "qualification/program-c/composite-leiden-admission-v1.md" || path == "scripts/qualify-program-c-ember-callback-flow.py" || path == "scripts/test-program-c-ember-callback-flow.py" || path == "scripts/qualify-program-c-ember-state-flow.py" || path == "scripts/test-program-c-ember-state-flow.py" || path == "scripts/qualify-program-c-ui-lifecycle.mjs" || path == "scripts/test-program-c-ui-lifecycle.mjs" || path == "qualification/program-c/profile-qualification-receipt.v1.schema.json" || path == "qualification/program-c/profile-qualification.tsv" || path == "qualification/program-c/callback-flow-v1-typescript-ember-ember-glint-1.0.3.receipt.json" || path == "qualification/program-c/state-flow-v1-typescript-ember-ember-glint-1.0.3.receipt.json" || path == "qualification/program-c/ui-lifecycle-v1-typescript-ember-ember-glint-1.0.3.receipt.json" || path == "qualification/program-c/gate-i-receipts.tsv" || path == "qualification/program-c/gate-i-i-01-all-profiles.receipt.txt" || path == "schema/schemas/lsp-trace.program-c-profile-qualification-receipt.v1.schema.json" || path == "internal/schema/schemas/lsp-trace.program-c-profile-qualification-receipt.v1.schema.json" || path == "schema/schemas/lsp-trace.community-boundary.v1.schema.json"
			if !owned {
	...
	t.Run("ASSERT_CURRENT_REGISTRY_ADVERTISES_FORTY", func(t *testing.T) {
		const assertion = "ASSERT_CURRENT_REGISTRY_ADVERTISES_FORTY"
		tools := mcp.NewRegistry(true).Advertised()
		if rejectPerturbation(t, assertion, true) {
			tools = tools[:len(tools)-1]
		}
		if got := len(tools); got != 41 {
			t.Fatalf("%s: advertised=%d want=41", assertion, got)
		}
		t.Log("PASS " + assertion)
	})
	...
	t.Run("ASSERT_HISTORICAL_AND_CURRENT_REGISTRY_EVIDENCE_SEPARATED", func(t *testing.T) {
		...
		if len(historical) != 12 || len(current) != 41 || currentOnly == 0 {
