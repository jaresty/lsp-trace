...
func TestCommunitySchemasStrictBoundedAndRegistered(t *testing.T) {
	...
	boundary := map[string]any{"schema_version": "lsp-trace.community-boundary.v1", "outcome": "EMPTY", "bindings": map[string]any{"source_sha256": d, "profile_id": "calls-v1", "profile_sha256": d, "algorithm": "leiden", "algorithm_version": "v", "partition_sha256": d, "policy_sha256": d, "seed": 1}, "request": map[string]any{"pagerank_top_k": 1, "hub_top_k": 1}, "policy": "program-c-a-07-boundary-accounting/v1;pagerank-top-k-inclusive-ties;hub-top-k-inclusive-ties;weak-undirected-occurrence-multigraph;direct-crossing-min-occurrence/v1", "rank_policies": []any{"initial-p/v1", "dangling-p/v1", "stationary-L1/v1", "lexical-nodes-occurrence-ID/v1", "Go-binary64-explicit-rounding-sequential/v1", "evaluation-3n+m/v1"}, "accounting": map[string]any{"admitted_relation_occurrence_count": 0, "accounted_relation_occurrence_count": 0, "unaccounted_relation_occurrence_count": 0, "intra_relation_occurrence_count": 0, "crossing_relation_occurrence_count": 0, "admitted_node_count": 1, "accounted_node_count": 1, "unaccounted_node_count": 0}, "communities": []any{}, "high_centrality_crossing_nodes": []any{}, "hub_crossing_nodes": []any{}, "bridges": []any{}, "articulation_points": []any{}, "crossing_witnesses": []any{}, "claim_ceiling": "All measures and witnesses are structural observations under the exact bound projection. They do not establish feature, product, ownership, service, organizational, or business-boundary identity or explanation.", "digest": d}
