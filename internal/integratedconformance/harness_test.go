	...
	t.Run("ASSERT_PACKAGE_OWNERSHIP_ONLY", func(t *testing.T) {
		...
		for _, line := range strings.Split(strings.TrimSpace(string(out)), "\n") {
			...
			owned := path == "sessionruntime/sessionruntime.go" || path == "sessionruntime/sessionruntime_test.go" || path == "sessionruntime/roundtrip_test.go" || path == "sessionruntime/local_darwin_integration_test.go" ||
				...
				path == "cmd/lsp-trace/SKILL.md" || path == "cmd/lsp-trace-mcp/main.go" || path == "cmd/lsp-trace-mcp/main_test.go" || path == "cmd/lsp-trace-mcp/provider_collector.go" || path == "cmd/lsp-trace-mcp/process_integration_test.go" || path == "cmd/lsp-trace-mcp/bootstrap.go" || path == "cmd/lsp-trace-mcp/bootstrap_test.go" || path == "cmd/lsp-trace-mcp/bootstrap_process_test.go" || path == "cmd/lsp-trace-mcp/bootstrap_provider.go" || path == "cmd/lsp-trace-mcp/bootstrap_provider_test.go" || path == "bootstrap-provider-declarations.claim.md" ||
