...
assert_contains DOC-MCP-PROJECT-CONFIG .mcp.json '"compact"'
...
assert_contains DOC-PI-COMPACT-TEN README.md 'The recommended compact profile advertises exactly ten canonical MCP names'
