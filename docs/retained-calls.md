...
The current runtime has exactly 35 canonical tools, sorted as: `lsp_session_v1_list`,
...
`lsp_trace_v1_program_c_compose`, `lsp_trace_v1_program_c_instability`, `lsp_trace_v1_program_c_leiden`, `lsp_trace_v1_schema_get`, `lsp_trace_v1_slice`, `lsp_trace_v1_structural_context`, `lsp_trace_v1_trace`, `lsp_trace_v1_validate`,
