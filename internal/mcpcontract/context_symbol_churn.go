...
func ValidateContextSymbolChurnEnvelopeExclusive(raw []byte) error {
	...
	if id != ContextSymbolChurnSuccessID && id != ContextSymbolChurnSuccessV2ID && id != ContextSymbolChurnDomainErrorID {
