...
func TestExecutionToolRegistryDiscoveryAndClosedSchema(t *testing.T) {
	...
	if !ok || !aliasOK || alias.Name != executionToolName || canonical.Availability != Enabled || canonical.Description == "" || canonical.InputSchema["additionalProperties"] != false || len(branches) != 38 {
