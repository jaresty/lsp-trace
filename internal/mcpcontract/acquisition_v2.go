...
const GraphV5SourceSnapshotArtifactID = "https://jaresty.github.io/lsp-trace/schemas/lsp-trace.graph-v5-source-snapshot.v1.schema.json"
...
func WithAcquisitionV3(m *Manifest) *Manifest {
	...
	copy.Schemas = append(copy.Schemas,
		SchemaRegistration{ID: GraphProvenanceV3ArtifactID, Family: "lsp-trace.graph-provenance.v3", Layer: "artifact", Path: "../../schema/schemas/lsp-trace.graph-provenance.v3.schema.json"},
		SchemaRegistration{ID: GraphProvenanceV5ArtifactID, Family: "lsp-trace.graph-provenance.v5", Layer: "artifact", Path: "../../schema/schemas/lsp-trace.graph-provenance.v5.schema.json"},
		SchemaRegistration{ID: GraphV5SourceSnapshotArtifactID, Family: "lsp-trace.graph-v5-source-snapshot.v1", Layer: "artifact", Path: "../../schema/schemas/lsp-trace.graph-v5-source-snapshot.v1.schema.json"},
	)
