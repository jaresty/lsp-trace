...
func DecodeNativeV3(data []byte) (Result, error) {
	...
	if header.SchemaVersion != SchemaVersionV5 {
	...
	r := Result{SchemaVersion: b.SchemaVersion, Invocation: b.Invocation, Tool: b.Tool, Targets: b.Targets, Nodes: b.Nodes, Edges: b.Edges, Terminals: b.Terminals, Frontier: b.Frontier, Diagnostics: b.Diagnostics, Seeds: b.Seeds, Slice: b.Slice, SiblingCandidates: b.SiblingCandidates, DispatchRelationships: b.DispatchRelationships, Capabilities: b.Capabilities, CapabilityQuality: b.CapabilityQuality, Summary: Summary{NodeCount: b.Summary.NodeCount, EdgeCount: b.Summary.EdgeCount, TerminalCount: b.Summary.TerminalCount, CycleCount: b.Summary.CycleCount, Complete: b.Summary.TraversalComplete, Truncated: b.Summary.Truncated}}
	for i := range r.Seeds {
