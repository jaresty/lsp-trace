...
const allowed = [
  ...
  'fixtures/source-constrained-synthetic/invokes-task-any.js',
  'fixtures/source-constrained-synthetic/invokes-task-negative.js',
  'fixtures/source-constrained-synthetic/invokes-task-positive.js',
  'fixtures/source-constrained-synthetic/invokes-task-unresolved.js',
  'fixtures/source-constrained-synthetic/provenance.json',
  'fixtures/source-constrained-synthetic/triggers-reload-negative.js',
  'fixtures/source-constrained-synthetic/triggers-reload-positive.js',
  'fixtures/source-constrained-synthetic/triggers-reload-unknown.js',
  'fixtures/source-constrained-synthetic/triggers-reload-unresolved.js',
  ...
  'package.json', 'qualification/observe.mjs', 'qualification/type-overlay.mjs', 'src/protocol.mjs',
];
