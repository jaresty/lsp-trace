...
family. Canonical `lsp_trace_v2_verify_retained_calls` accepts a standard immutable
generation selector plus explicit `schema:{family:"retained-calls",version:"v2"}`;
...
The current runtime has exactly 41 canonical tools, sorted as: `lsp_session_v1_list`,
...
`lsp_trace_v1_context_churn`, `lsp_trace_v1_context_symbol_churn`, `lsp_trace_v1_context_symbol_churn_capture`, `lsp_trace_v1_custody_execute`, `lsp_trace_v1_execute`, `lsp_trace_v1_export_retained_calls`, `lsp_trace_v1_filter`,
`lsp_trace_v1_incoming`, `lsp_trace_v1_inspect`, `lsp_trace_v1_inspect_hydrated`,
`lsp_trace_v1_program_c_compose`, `lsp_trace_v1_program_c_instability`, `lsp_trace_v1_program_c_leiden`, `lsp_trace_v1_schema_get`, `lsp_trace_v1_slice`, `lsp_trace_v1_structural_context`, `lsp_trace_v1_structural_context_symbol`, `lsp_trace_v1_structural_delta`, `lsp_trace_v1_trace`, `lsp_trace_v1_validate`,
