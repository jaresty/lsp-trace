	...
	t.Run("ASSERT_PACKAGE_OWNERSHIP_ONLY", func(t *testing.T) {
		...
		for _, line := range strings.Split(strings.TrimSpace(string(out)), "\n") {
			...
			owned := path == "sessionruntime/sessionruntime.go" || path == "sessionruntime/sessionruntime_test.go" || path == "sessionruntime/roundtrip_test.go" || path == "sessionruntime/local_darwin_integration_test.go" ||
				...
				path == "README.md" || path == "docs/PROVIDERS.md" || path == "scripts/check-docs.sh" || path == "docs/adr/0003-always-local-stage2.md" || path == "docs/adr/0003-persistent-mcp-language-server-sessions.md" ||
				...
				path == "internal/provider/collector.go" || path == "internal/provider/collector_test.go" || path == "internal/provider/semantic_binding.go" || path == "internal/provider/semantic_binding_test.go" || path == "internal/provider/provisioning.go" || path == "internal/provider/admission.go" || path == "internal/provider/admission_test.go" || path == "internal/provider/inventory.go" || path == "internal/provider/inventory_test.go" || path == "internal/mcp/provider_inventory_test.go" || path == "configured-provider-inventory.claim.md" || path == "generic-provider-conformance.claim.md" || strings.HasPrefix(path, "internal/providerconformance/") || path == "cmd/lsp-trace/provider_conformance_command.go" || path == "cmd/lsp-trace/provider_conformance_command_test.go" || path == "schema/schemas/lsp-trace.provider-conformance-request.v1.schema.json" || path == "schema/schemas/lsp-trace.provider-conformance-report.v1.schema.json" || strings.HasPrefix(path, "internal/mcpcontract/") || strings.HasPrefix(path, "incomingops/") || strings.HasPrefix(path, "sliceops/") || strings.HasPrefix(path, "internal/traverse/") || strings.HasPrefix(path, "internal/execution/") || strings.HasPrefix(path, "internal/observationadapter/") || path == "observation-adaptation.claim.md" || path == "frozen-glint-qualification.claim.md" || strings.HasPrefix(path, "qualification/provider-qualification/") || strings.HasPrefix(path, "qualification/retained/provider-qualification/") || strings.HasPrefix(path, "internal/integratedconformance/") ||
