...
const usageText = `usage:
  ...
  lsp-trace slice --production-v5 --workspace PATH --server COMMAND (--seed-manifest PATH | --from-file PATH...)  # automatic discovery retains canonical lsp-trace.seeds.v2 in V5
  ...
  lsp-trace export-retained-calls [--version v1|v2|v3] [--output SELECTOR] PATH|-
